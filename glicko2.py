...
glicko2.py
----------
SIN CAMBIOS por la migracion a ESPN -- la matematica de Glicko-2 no
depende de ningun proveedor de datos en vivo.

Implementacion del sistema Glicko-2 (Mark Glickman), usado como el
"rating propio" del proyecto. Se eligio sobre Elo puro porque modela
explicitamente la INCERTIDUMBRE (RD) y la VOLATILIDAD (sigma) de cada
equipo, no solo su fuerza.

Referencia del algoritmo: http://www.glicko.net/glicko/glicko2.pdf

Valores por defecto:
  rating inicial = 1500
  RD inicial     = 350   (maxima incertidumbre)
  volatilidad    = 0.06
  tau            = 0.5
"""
